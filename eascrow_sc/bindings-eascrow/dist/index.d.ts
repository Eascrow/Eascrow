...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CC2P2SZKKEWCBJGD4BMM5AAGJNX2Z7FIVLNJCVJRXW4USVHK36DR7IKL";
    };
};
...
export interface Client {
     ...
     */
    initialize: ({ buyer, seller, token, authorized_address, price }: {
        buyer: string;
        seller: string;
        token: string;
     ...
     */
    fund: ({ buyer, tokens_to_transfer }: {
        buyer: string;
        tokens_to_transfer: i128;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
         */
